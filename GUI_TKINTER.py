...
class ChairGuardianApp(ctk.CTk):
    ...
    def open_gallery(self):
        ...
        for i, event in enumerate(self.events):
            ...
            label = ctk.CTkLabel(card, text=f"Event {i+1}")
            ...
            keep_btn = ctk.CTkButton(card, text="Keep", fg_color="green", command=make_keep())
            keep_btn.pack(side="right", padx=5)

            del_btn = ctk.CTkButton(card, text="Delete", fg_color="red", command=make_delete())
